...
- (void)createNavBarWithTitle:(NSString *)title
{
    ...
    navBarContainer.frame = CGRectMake(0, 0, ZLScreenW, 64);
    ...
    navTitleLabel.font = ZLFontBold(17);
    ...
    navTitleLabel.width = size.width;
    navTitleLabel.left = ZLScreenW * 0.5 - navTitleLabel.width * 0.5;
