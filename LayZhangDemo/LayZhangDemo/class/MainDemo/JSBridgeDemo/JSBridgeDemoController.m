//
//  JSBridgeDemoController.m
//  LayZhangDemo
//
//  Created by LayZhang on 2017/10/23.
//  Copyright © 2017年 Zhanglei. All rights reserved.
//

#import "JSBridgeDemoController.h"
#import "WebViewJavascriptBridge.h"

@interface JSBridgeDemoController ()

@property WebViewJavascriptBridge *bridge;

@end

@implementation JSBridgeDemoController

- (void)viewDidLoad {
    [super viewDidLoad];
    [self createNavBarWithTitle:@"JSBridgeDemo"];
    UIWebView *webView = [[UIWebView alloc] init];
    webView.size = CGSizeMake(SCREENWIDTH, SCREENHEIGHT - 64);
    webView.top = 64;
...
//    [_bridge callHandler:@"loginAction" data:@"userid:1231231212" responseCallback:^(id responseData) {
//        NSLog(@"......");
//    }];
