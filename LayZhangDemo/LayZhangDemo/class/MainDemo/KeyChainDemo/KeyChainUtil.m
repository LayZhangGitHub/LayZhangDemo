...
static NSString * const kPDDictionaryKey = @"com.zhanglei.dictionaryKey";
static NSString * const kPDKeyChainKey = @"com.zhanglei.keychainKey";

@implementation KeyChainUtil

+ (void)keyChainSaveDic:(NSDictionary *)dic {
    [self save:kPDKeyChainKey data:dic];
}
